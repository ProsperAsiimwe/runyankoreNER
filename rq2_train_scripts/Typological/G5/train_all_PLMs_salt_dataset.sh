...
export DATA_DIR="data/TypologicalGroups/G5/G5_SALT/"
export OUTPUT_DIR="models/TypologicalGroups/G5/salt_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/G5/salt_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/G5/salt_xlmr"
