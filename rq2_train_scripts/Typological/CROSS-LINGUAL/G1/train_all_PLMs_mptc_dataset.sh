...
export DATA_DIR="data/TypologicalGroups/G1/G1_MPTC/"
export OUTPUT_DIR="models/TypologicalGroups/G1/mptc_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/G1/mptc_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/G1/mptc_xlmr"
