...
export DATA_DIR="data/TypologicalGroups/G1/G1_COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/G1/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/G1/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/G1/combined_xlmr"
