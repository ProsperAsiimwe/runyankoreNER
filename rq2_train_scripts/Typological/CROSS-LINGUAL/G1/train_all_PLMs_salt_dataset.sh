...
export DATA_DIR="data/TypologicalGroups/G1/G1_SALT/"
export OUTPUT_DIR="models/TypologicalGroups/G1/salt_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/G1/salt_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/G1/salt_xlmr"
