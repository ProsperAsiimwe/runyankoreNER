...
export DATA_DIR="data/TypologicalGroups/Low-A/COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/Low-A/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/Low-A/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/Low-A/combined_xlmr"
