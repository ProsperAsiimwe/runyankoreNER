...
export DATA_DIR="data/TypologicalGroups/G4/G4_SALT/"
export OUTPUT_DIR="models/TypologicalGroups/G4/salt_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/G4/salt_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/G4/salt_xlmr"
