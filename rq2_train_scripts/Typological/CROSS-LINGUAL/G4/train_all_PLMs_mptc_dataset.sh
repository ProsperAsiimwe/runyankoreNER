...
export DATA_DIR="data/TypologicalGroups/G4/G4_MPTC/"
export OUTPUT_DIR="models/TypologicalGroups/G4/mptc_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/G4/mptc_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/G4/mptc_xlmr"
