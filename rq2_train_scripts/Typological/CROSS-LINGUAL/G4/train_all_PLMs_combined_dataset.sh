...
export DATA_DIR="data/TypologicalGroups/G4/G4_COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/G4/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/G4/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/G4/combined_xlmr"
