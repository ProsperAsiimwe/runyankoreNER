...
export DATA_DIR="data/TypologicalGroups/G6/G6_COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/G6/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/G6/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/G6/combined_xlmr"
