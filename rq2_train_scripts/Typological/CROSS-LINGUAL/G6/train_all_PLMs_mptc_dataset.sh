...
export DATA_DIR="data/TypologicalGroups/G6/G6_MPTC/"
export OUTPUT_DIR="models/TypologicalGroups/G6/mptc_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/G6/mptc_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/G6/mptc_xlmr"
