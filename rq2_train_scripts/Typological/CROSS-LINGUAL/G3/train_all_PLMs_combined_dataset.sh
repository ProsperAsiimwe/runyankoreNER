...
export DATA_DIR="data/TypologicalGroups/G3/G3_COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/G3/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/G3/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/G3/combined_xlmr"
