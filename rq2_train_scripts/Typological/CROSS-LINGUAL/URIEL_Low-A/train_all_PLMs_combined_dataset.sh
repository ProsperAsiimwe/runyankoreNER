...
export DATA_DIR="data/TypologicalGroups/CROSS-LINGUAL/URIEL_Low-A/COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/CROSS-LINGUAL/URIEL_Low-A/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/CROSS-LINGUAL/URIEL_Low-A/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/CROSS-LINGUAL/URIEL_Low-A/combined_xlmr"
