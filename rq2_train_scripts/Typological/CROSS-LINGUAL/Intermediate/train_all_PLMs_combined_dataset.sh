...
export DATA_DIR="data/TypologicalGroups/Intermediate/COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/Intermediate/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/Intermediate/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/Intermediate/combined_xlmr"
