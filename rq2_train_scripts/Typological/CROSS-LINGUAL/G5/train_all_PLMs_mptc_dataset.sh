...
export DATA_DIR="data/TypologicalGroups/G5/G5_MPTC/"
export OUTPUT_DIR="models/TypologicalGroups/G5/mptc_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/G5/mptc_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/G5/mptc_xlmr"
