...
export DATA_DIR="data/TypologicalGroups/G5/G5_COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/G5/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/G5/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/G5/combined_xlmr"
