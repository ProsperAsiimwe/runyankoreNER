...
export DATA_DIR="data/TypologicalGroups/CROSS-LINGUAL/LinguaMeta_High/COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/CROSS-LINGUAL/LinguaMeta_High/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/CROSS-LINGUAL/LinguaMeta_High/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/CROSS-LINGUAL/LinguaMeta_High/combined_xlmr"
