...
export DATA_DIR="data/TypologicalGroups/Low-B/COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/Low-B/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/Low-B/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/Low-B/combined_xlmr"
