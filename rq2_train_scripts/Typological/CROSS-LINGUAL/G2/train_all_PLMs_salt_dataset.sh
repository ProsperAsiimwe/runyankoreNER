...
export DATA_DIR="data/TypologicalGroups/G2/G2_SALT/"
export OUTPUT_DIR="models/TypologicalGroups/G2/salt_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/G2/salt_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/G2/salt_xlmr"
