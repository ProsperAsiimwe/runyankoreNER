...
export DATA_DIR="data/TypologicalGroups/G2/G2_COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/G2/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/G2/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/G2/combined_xlmr"
