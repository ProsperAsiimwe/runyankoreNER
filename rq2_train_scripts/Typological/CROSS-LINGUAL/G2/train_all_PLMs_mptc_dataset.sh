...
export DATA_DIR="data/TypologicalGroups/G2/G2_MPTC/"
export OUTPUT_DIR="models/TypologicalGroups/G2/mptc_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/G2/mptc_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/G2/mptc_xlmr"
