...
export DATA_DIR="data/TypologicalGroups/High-B/COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/High-B/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/High-B/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/High-B/combined_xlmr"
