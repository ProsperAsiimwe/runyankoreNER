...
export DATA_DIR="data/TypologicalGroups/High–A/COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/High–A/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/High–A/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/High–A/combined_xlmr"
