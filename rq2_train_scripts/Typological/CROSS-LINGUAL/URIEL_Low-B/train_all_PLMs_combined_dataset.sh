...
export DATA_DIR="data/TypologicalGroups/CROSS-LINGUAL/URIEL_Low-B/COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/CROSS-LINGUAL/URIEL_Low-B/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/CROSS-LINGUAL/URIEL_Low-B/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/CROSS-LINGUAL/URIEL_Low-B/combined_xlmr"
