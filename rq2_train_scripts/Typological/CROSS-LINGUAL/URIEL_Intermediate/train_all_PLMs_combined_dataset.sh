...
export DATA_DIR="data/TypologicalGroups/CROSS-LINGUAL/URIEL_Intermediate/COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/CROSS-LINGUAL/URIEL_Intermediate/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/CROSS-LINGUAL/URIEL_Intermediate/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/CROSS-LINGUAL/URIEL_Intermediate/combined_xlmr"
