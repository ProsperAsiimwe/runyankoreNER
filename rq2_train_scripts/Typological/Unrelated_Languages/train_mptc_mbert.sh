...
export DATA_DIR="data/TypologicalGroupCombined_Unrelated_Languages/TypoGroup_MPTC/"
export OUTPUT_DIR="models/TypologicalGroupCombined_Unrelated_Languages/mptc_mbert"
