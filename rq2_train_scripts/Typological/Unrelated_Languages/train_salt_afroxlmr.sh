...
export DATA_DIR="data/TypologicalGroupCombined_Unrelated_Languages/TypoGroup_SALT/"
export OUTPUT_DIR="models/TypologicalGroupCombined_Unrelated_Languages/salt_afroxlmr"
