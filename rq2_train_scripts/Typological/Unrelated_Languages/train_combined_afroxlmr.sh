...
export DATA_DIR="data/TypologicalGroupCombined_Unrelated_Languages/TypoGroup_COMBINED/"
export OUTPUT_DIR="models/TypologicalGroupCombined_Unrelated_Languages/combined_afroxlmr"
