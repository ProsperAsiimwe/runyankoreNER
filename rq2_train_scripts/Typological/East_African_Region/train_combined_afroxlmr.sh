...
export DATA_DIR="data/TypologicalGroupCombined_East_African_Region/TypoGroup_COMBINED/"
export OUTPUT_DIR="models/TypologicalGroupCombined_East_African_Region/combined_afroxlmr"
