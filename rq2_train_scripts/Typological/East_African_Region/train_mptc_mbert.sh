...
export DATA_DIR="data/TypologicalGroupCombined_East_African_Region/TypoGroup_MPTC/"
export OUTPUT_DIR="models/TypologicalGroupCombined_East_African_Region/mptc_mbert"
