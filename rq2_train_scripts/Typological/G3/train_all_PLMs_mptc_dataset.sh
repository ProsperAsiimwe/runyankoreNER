...
export DATA_DIR="data/TypologicalGroups/G3/G3_MPTC/"
export OUTPUT_DIR="models/TypologicalGroups/G3/mptc_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/G3/mptc_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/G3/mptc_xlmr"
