...
export DATA_DIR="data/TypologicalGroups/G3/G3_SALT/"
export OUTPUT_DIR="models/TypologicalGroups/G3/salt_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/G3/salt_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/G3/salt_xlmr"
