...
export DATA_DIR="data/TypologicalGroups/G6/G6_SALT/"
export OUTPUT_DIR="models/TypologicalGroups/G6/salt_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/G6/salt_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/G6/salt_xlmr"
