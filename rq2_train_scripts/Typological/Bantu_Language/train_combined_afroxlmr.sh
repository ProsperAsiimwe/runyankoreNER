...
export DATA_DIR="data/TypologicalGroupCombined_Bantu_Language/TypoGroup_COMBINED/"
export OUTPUT_DIR="models/TypologicalGroupCombined_Bantu_Language/combined_afroxlmr"
