...
export DATA_DIR="data/TypologicalGroupCombined_Bantu_Language/TypoGroup_SALT/"
export OUTPUT_DIR="models/TypologicalGroupCombined_Bantu_Language/salt_afroxlmr"
