...
export DATA_DIR="data/TypologicalGroups/ZERO-SHOT/G4/MPTC/"
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/G4/mptc_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/G4/mptc_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/G4/mptc_xlmr"
