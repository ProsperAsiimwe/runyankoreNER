...
export DATA_DIR="data/TypologicalGroups/ZERO-SHOT/G4/SALT/"
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/G4/salt_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/G4/salt_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/G4/salt_xlmr"
