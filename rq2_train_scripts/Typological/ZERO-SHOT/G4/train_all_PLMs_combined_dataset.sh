...
export DATA_DIR="data/TypologicalGroups/ZERO-SHOT/G4/COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/G4/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/G4/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/G4/combined_xlmr"
