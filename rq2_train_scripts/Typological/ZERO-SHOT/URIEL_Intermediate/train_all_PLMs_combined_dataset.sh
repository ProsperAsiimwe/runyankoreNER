...
export DATA_DIR="data/TypologicalGroups/ZERO-SHOT/URIEL_Intermediate/COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/URIEL_Intermediate/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/URIEL_Intermediate/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/URIEL_Intermediate/combined_xlmr"
