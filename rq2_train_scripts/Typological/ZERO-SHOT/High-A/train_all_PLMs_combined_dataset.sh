...
export DATA_DIR="data/TypologicalGroups/ZERO-SHOT/High–A/COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/High–A/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/High–A/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/High–A/combined_xlmr"
