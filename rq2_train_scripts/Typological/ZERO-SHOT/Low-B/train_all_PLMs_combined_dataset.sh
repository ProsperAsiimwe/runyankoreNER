...
export DATA_DIR="data/TypologicalGroups/ZERO-SHOT/Low-B/COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/Low-B/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/Low-B/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/Low-B/combined_xlmr"
