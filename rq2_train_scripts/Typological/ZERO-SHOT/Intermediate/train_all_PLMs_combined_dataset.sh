...
export DATA_DIR="data/TypologicalGroups/ZERO-SHOT/Intermediate/COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/Intermediate/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/Intermediate/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/Intermediate/combined_xlmr"
