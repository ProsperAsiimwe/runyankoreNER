...
export DATA_DIR="data/TypologicalGroups/ZERO-SHOT/0-B/COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/0-B/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/0-B/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/0-B/combined_xlmr"
