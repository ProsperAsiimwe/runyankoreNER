...
export DATA_DIR="data/TypologicalGroups/ZERO-SHOT/URIEL_Low-B/COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/URIEL_Low-B/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/URIEL_Low-B/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/URIEL_Low-B/combined_xlmr"
