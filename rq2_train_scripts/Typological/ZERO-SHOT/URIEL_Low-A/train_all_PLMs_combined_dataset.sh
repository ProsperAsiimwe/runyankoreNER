...
export DATA_DIR="data/TypologicalGroups/ZERO-SHOT/URIEL_Low-A/COMBINED/"
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/URIEL_Low-A/combined_afroxlmr"
...
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/URIEL_Low-A/combined_mbert"
...
export OUTPUT_DIR="models/TypologicalGroups/ZERO-SHOT/URIEL_Low-A/combined_xlmr"
