...
Assumed layout (relative to a ROOT that ends at ".../outputs/salt"):
...
def scan_best_by_layer_for_tech(model_root: str, model: str, technique: str, options: dict):
    ...
    """
    model_dir = model_root  # already ends with .../outputs/salt/<model>
...
def main():
    ...
    candidates = [
        ...
        abspath_from_script("outputs", "salt"),    # common repo layout
        "rq2_train_scripts/Embeddings/CLEAN/outputs/salt",  # legacy path
    ]
    root = None
