...
<root>/salt/<MODEL>/config_<i>_cls<true|false>_ctx<true|false>/tokens_<T>_ctx<C>/
...
Default root: rq2_train_scripts/Embeddings/CLEAN/outputs/salt
"""
...
def main():
    ...
    ap.add_argument("--root", default="rq2_train_scripts/Embeddings/CLEAN/outputs/salt",
    ...
    ap.add_argument("--outdir", default="rq2_train_scripts/Embeddings/CLEAN/outputs/salt/summary_best",
