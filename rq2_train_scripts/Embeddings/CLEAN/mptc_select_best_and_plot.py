...
<root>/mptc/<MODEL>/config_<i>_cls<true|false>_ctx<true|false>/tokens_<T>_ctx<C>/
...
Default root: rq2_train_scripts/Embeddings/CLEAN/outputs/mptc
"""
...
def scan_best_by_layer_for_tech(
    ...
    # model_root already points to the model directory (e.g., .../mptc/xlmr)
...
def main():
    ...
    ap.add_argument("--root", default="rq2_train_scripts/Embeddings/CLEAN/outputs/mptc",
    ...
    ap.add_argument("--outdir", default="rq2_train_scripts/Embeddings/CLEAN/outputs/mptc/summary_best",
