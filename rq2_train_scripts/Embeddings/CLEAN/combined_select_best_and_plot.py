...
Assumed layout (relative to a ROOT that ends at ".../outputs/combined"):
...
def scan_best_by_layer_for_tech(model_root: str, model: str, technique: str, options: dict):
    ...
    """
    model_dir = model_root  # already ends with .../outputs/combined/<model>
...
def main():
    ...
    candidates = [
        ...
        abspath_from_script("outputs", "combined"),    # common repo layout
        "rq2_train_scripts/Embeddings/CLEAN/outputs/combined",  # legacy path
    ]
    root = None
