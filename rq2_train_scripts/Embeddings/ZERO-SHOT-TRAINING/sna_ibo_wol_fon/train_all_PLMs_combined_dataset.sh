...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/sna_ibo_wol_fon/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/sna_ibo_wol_fon/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/sna_ibo_wol_fon/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/sna_ibo_wol_fon/combined_xlmr"
