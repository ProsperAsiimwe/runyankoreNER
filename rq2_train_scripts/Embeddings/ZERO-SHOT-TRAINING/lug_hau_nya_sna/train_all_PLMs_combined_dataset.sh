...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/lug_hau_nya_sna/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/lug_hau_nya_sna/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/lug_hau_nya_sna/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/lug_hau_nya_sna/combined_xlmr"
