...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/twi_kin_ewe_swa/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_kin_ewe_swa/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_kin_ewe_swa/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_kin_ewe_swa/combined_xlmr"
