...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/ibo_xho_fon_lug/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/ibo_xho_fon_lug/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/ibo_xho_fon_lug/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/ibo_xho_fon_lug/combined_xlmr"
