...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/luo_swa_twi/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/luo_swa_twi/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/luo_swa_twi/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/luo_swa_twi/combined_xlmr"
