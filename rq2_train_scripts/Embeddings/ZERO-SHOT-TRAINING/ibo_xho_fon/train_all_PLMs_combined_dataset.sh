...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/ibo_xho_fon/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/ibo_xho_fon/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/ibo_xho_fon/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/ibo_xho_fon/combined_xlmr"
