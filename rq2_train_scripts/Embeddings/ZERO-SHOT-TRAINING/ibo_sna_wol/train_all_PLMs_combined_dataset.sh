...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/ibo_sna_wol/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/ibo_sna_wol/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/ibo_sna_wol/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/ibo_sna_wol/combined_xlmr"
