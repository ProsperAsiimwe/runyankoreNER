...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/pcm_sna_kin_luo/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/pcm_sna_kin_luo/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/pcm_sna_kin_luo/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/pcm_sna_kin_luo/combined_xlmr"
