...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/lug_sna_xho_kin/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/lug_sna_xho_kin/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/lug_sna_xho_kin/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/lug_sna_xho_kin/combined_xlmr"
