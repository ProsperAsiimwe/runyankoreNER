...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/sna_ibo_wol/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/sna_ibo_wol/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/sna_ibo_wol/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/sna_ibo_wol/combined_xlmr"
