...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/kin_sna_xho/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/kin_sna_xho/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/kin_sna_xho/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/kin_sna_xho/combined_xlmr"
