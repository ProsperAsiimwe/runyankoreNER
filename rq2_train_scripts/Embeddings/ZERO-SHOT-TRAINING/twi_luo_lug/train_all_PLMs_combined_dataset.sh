...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/twi_luo_lug/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_luo_lug/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_luo_lug/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_luo_lug/combined_xlmr"
