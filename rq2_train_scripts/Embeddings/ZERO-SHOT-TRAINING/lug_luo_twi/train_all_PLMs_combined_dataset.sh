...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/lug_luo_twi/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/lug_luo_twi/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/lug_luo_twi/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/lug_luo_twi/combined_xlmr"
