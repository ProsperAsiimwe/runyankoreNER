...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/xho_ibo_lug_bam/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/xho_ibo_lug_bam/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/xho_ibo_lug_bam/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/xho_ibo_lug_bam/combined_xlmr"
