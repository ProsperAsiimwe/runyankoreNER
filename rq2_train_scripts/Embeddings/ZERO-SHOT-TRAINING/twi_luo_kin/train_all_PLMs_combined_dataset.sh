...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/twi_luo_kin/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_luo_kin/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_luo_kin/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_luo_kin/combined_xlmr"
