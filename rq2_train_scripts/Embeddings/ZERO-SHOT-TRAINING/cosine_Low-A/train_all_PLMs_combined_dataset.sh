...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/cosine_Low-A/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/cosine_Low-A/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/cosine_Low-A/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/cosine_Low-A/combined_xlmr"
