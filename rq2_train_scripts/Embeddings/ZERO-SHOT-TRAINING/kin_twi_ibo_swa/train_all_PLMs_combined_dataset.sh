...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/kin_twi_ibo_swa/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/kin_twi_ibo_swa/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/kin_twi_ibo_swa/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/kin_twi_ibo_swa/combined_xlmr"
