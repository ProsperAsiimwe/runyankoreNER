...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/hau_lug_sna/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/hau_lug_sna/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/hau_lug_sna/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/hau_lug_sna/combined_xlmr"
