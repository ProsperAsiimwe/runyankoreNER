...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/kin_twi_ibo/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/kin_twi_ibo/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/kin_twi_ibo/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/kin_twi_ibo/combined_xlmr"
