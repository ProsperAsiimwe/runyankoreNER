...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/twi_luo_kin_zul/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_luo_kin_zul/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_luo_kin_zul/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_luo_kin_zul/combined_xlmr"
