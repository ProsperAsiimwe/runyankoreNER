...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/cosine_High/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/cosine_High/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/cosine_High/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/cosine_High/combined_xlmr"
