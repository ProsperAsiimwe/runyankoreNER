...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/swd_High/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/swd_High/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/swd_High/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/swd_High/combined_xlmr"
