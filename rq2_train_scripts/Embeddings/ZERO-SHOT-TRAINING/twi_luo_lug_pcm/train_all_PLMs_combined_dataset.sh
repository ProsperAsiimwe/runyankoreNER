...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/twi_luo_lug_pcm/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_luo_lug_pcm/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_luo_lug_pcm/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_luo_lug_pcm/combined_xlmr"
