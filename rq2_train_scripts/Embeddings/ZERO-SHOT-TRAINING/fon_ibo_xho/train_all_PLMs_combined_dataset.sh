...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/fon_ibo_xho/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/fon_ibo_xho/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/fon_ibo_xho/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/fon_ibo_xho/combined_xlmr"
