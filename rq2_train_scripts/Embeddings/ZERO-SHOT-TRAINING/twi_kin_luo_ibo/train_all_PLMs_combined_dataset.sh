...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/twi_kin_luo_ibo/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_kin_luo_ibo/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_kin_luo_ibo/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_kin_luo_ibo/combined_xlmr"
