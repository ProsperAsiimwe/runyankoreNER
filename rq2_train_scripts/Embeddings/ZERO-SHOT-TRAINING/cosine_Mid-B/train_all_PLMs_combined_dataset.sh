...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/cosine_Mid-B/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/cosine_Mid-B/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/cosine_Mid-B/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/cosine_Mid-B/combined_xlmr"
