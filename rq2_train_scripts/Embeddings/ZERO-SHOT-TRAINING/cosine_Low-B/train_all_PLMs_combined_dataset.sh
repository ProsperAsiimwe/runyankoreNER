...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/cosine_Low-B/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/cosine_Low-B/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/cosine_Low-B/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/cosine_Low-B/combined_xlmr"
