...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/twi_swa_luo/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_swa_luo/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_swa_luo/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/twi_swa_luo/combined_xlmr"
