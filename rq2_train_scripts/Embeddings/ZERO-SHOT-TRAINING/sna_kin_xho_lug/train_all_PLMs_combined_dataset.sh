...
export DATA_DIR="data/EmbeddingGroups/ZERO-SHOT/sna_kin_xho_lug/COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/sna_kin_xho_lug/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/sna_kin_xho_lug/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/ZERO-SHOT/sna_kin_xho_lug/combined_xlmr"
