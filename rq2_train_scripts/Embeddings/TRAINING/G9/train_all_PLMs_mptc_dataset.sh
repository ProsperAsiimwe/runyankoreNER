...
export DATA_DIR="data/EmbeddingGroups/G9/G9_MPTC/"
export OUTPUT_DIR="models/EmbeddingGroups/G9/mptc_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/G9/mptc_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/G9/mptc_xlmr"
