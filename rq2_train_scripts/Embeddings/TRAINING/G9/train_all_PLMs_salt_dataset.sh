...
export DATA_DIR="data/EmbeddingGroups/G9/G9_SALT/"
export OUTPUT_DIR="models/EmbeddingGroups/G9/salt_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/G9/salt_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/G9/salt_xlmr"
