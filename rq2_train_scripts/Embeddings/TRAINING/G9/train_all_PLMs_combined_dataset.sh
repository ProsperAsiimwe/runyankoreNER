...
export DATA_DIR="data/EmbeddingGroups/G9/G9_COMBINED/"
export OUTPUT_DIR="models/EmbeddingGroups/G9/combined_afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/G9/combined_mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/G9/combined_xlmr"
