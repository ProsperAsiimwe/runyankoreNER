...
export DATA_DIR="data/EmbeddingGroups/COMBINED/xlmr_COMBINED/"

export OUTPUT_DIR="models/EmbeddingGroups/COMBINED_XLMR/afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/COMBINED_XLMR/mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/COMBINED_XLMR/xlmr"
