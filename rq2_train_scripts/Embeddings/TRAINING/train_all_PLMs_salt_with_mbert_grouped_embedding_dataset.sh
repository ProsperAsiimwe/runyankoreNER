...
export DATA_DIR="data/EmbeddingGroups/SALT/mbert_SALT/"

export OUTPUT_DIR="models/EmbeddingGroups/SALT_MBERT/afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/SALT_MBERT/mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/SALT_MBERT/xlmr"
