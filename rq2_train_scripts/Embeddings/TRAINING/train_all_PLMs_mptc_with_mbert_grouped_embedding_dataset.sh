...
export DATA_DIR="data/EmbeddingGroups/MPTC/mbert_MPTC/"

export OUTPUT_DIR="models/EmbeddingGroups/MPTC_MBERT/afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/MPTC_MBERT/mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/MPTC_MBERT/xlmr"
