...
export DATA_DIR="data/EmbeddingGroups/SALT/xlmr_SALT/"

export OUTPUT_DIR="models/EmbeddingGroups/SALT_XLMR/afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/SALT_XLMR/mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/SALT_XLMR/xlmr"
