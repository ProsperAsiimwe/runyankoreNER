...
export DATA_DIR="data/EmbeddingGroups/MPTC/xlmr_MPTC/"

export OUTPUT_DIR="models/EmbeddingGroups/MPTC_XLMR/afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/MPTC_XLMR/mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/MPTC_XLMR/xlmr"
