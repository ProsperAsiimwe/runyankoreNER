...
export DATA_DIR="data/EmbeddingGroups/COMBINED/mbert_COMBINED/"

export OUTPUT_DIR="models/EmbeddingGroups/COMBINED_MBERT/afroxlmr"
...
export OUTPUT_DIR="models/EmbeddingGroups/COMBINED_MBERT/mbert"
...
export OUTPUT_DIR="models/EmbeddingGroups/COMBINED_MBERT/xlmr"
