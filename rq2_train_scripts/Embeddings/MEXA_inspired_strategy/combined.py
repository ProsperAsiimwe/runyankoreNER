...
def compute_language_prototypes(language_files, model_type, max_tokens_per_type=500, output_dir="combined_outputs_prototypes",
...
def compute_similarity_to_target(all_prototypes, output_dir="combined_outputs_prototypes", use_hybrid=False):
    similarities = {}
