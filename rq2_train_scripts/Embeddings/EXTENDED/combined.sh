...
PY_SCRIPT="${PY_SCRIPT:-rq2_train_scripts/Embeddings/EXTENDED/combined.py}"

# Base output directory
BASE_OUTDIR="${BASE_OUTDIR:-rq2_train_scripts/Embeddings/EXTENDED/outputs/combined_cosine}"
