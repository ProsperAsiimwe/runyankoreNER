...
# Base directory containing all language subdirectories
DATA_DIR = os.path.join(os.path.dirname(__file__), "../MasakhaNER2.0/")

# MasakhaNER 2.0 language codes with their own directories
LANG_CODES = [
    "bam",
    "bbj",
    "ewe",
...
if __name__ == "__main__":
    for lang in LANG_CODES:
        ...
        if not os.path.isdir(lang_dir):
            print(f"Directory for language '{lang}' not found at: {lang_dir}")
            print("-" * 60)
            continue
        ...
        dataset_paths = {
            "Train": os.path.join(lang_dir, "train.txt"),
            "Dev": os.path.join(lang_dir, "dev.txt"),
            "Test": os.path.join(lang_dir, "test.txt"),
        }
