...
# === EDIT THESE === #
OUTPUT_DIR = Path("../EmbeddingGroups/ZERO-SHOT/swd_Low-B")  # <<< change to your desired output folder
MASAKHA_LANGUAGES = ["mos", "wol", "xho", "yor"]      # <<< change languages here (order matters)
# ================== #
