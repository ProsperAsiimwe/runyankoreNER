...
# === EDIT THESE === #
OUTPUT_DIR = Path("../EmbeddingGroups/ZERO-SHOT/2-A")  # <<< change to your desired output folder
MASAKHA_LANGUAGES = ["lug", "pcm", "ewe", "zul"]               # <<< change languages here (order matters)
# ================== #
