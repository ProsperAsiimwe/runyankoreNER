...
# === EDIT THESE === #
OUTPUT_DIR = Path("../EmbeddingGroups/ZERO-SHOT/Low-B")  # <<< change to your desired output folder
MASAKHA_LANGUAGES = ["wol", "ewe", "mos", "bam"]               # <<< change languages here (order matters)
# ================== #
