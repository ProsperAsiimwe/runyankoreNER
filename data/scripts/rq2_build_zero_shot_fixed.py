...
# === EDIT THESE === #
OUTPUT_DIR = Path("../EmbeddingGroups/ZERO-SHOT/cosine_Low-B")  # <<< change to your desired output folder
MASAKHA_LANGUAGES = ["mos", "yor", "swa", "bbj"]      # <<< change languages here (order matters)
# ================== #
